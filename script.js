        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            if (today === 0) {
                ...
                function tryPlayAudio() {
                    if (audioIndex >= audioUrls.length || audioPlayed) {
                        console.error('所有音频URL都加载失败或已播放');
                        return;
                    }
                    
                    const url = audioUrls[audioIndex];
                    console.log(`尝试播放音频 (${audioIndex + 1}/${audioUrls.length}):`, url);
                    ...
                    audio.onloadeddata = function() {
                        console.log('音频加载成功，等待用户交互后播放:', url);
                        audioPlayed = true;
                    };
